...
public final class PluginItemRegistry {
    ...
    public PluginItemRegistry(final ILogger logger) {
        this.logger = logger;
    ...
    public @Nullable PluginItem<?> fromReferenceNullable(@Nullable String plugin, @Nullable String itemId) {
        ...
        logger.error("Unsupported plugin item '" + itemId + "' from external plugin '" + plugin + "'."
    ...
    public @Nullable PluginItem<?> fromReferenceNullable(@Nullable String reference) {
        if (!isPluginItemId(reference)) {
            logger.error("The format of plugin item ID '" + reference + "' is not correct. Correct format: {plugin}:{itemId}");
            return null;
        }
