...
public final class VaultHook extends AbstractListener<JavaPlugin> {
    ...
    private VaultHook(@NotNull JavaPlugin plugin) {
        super(plugin);
        this.setPermission();
        this.setEconomy();
        this.setChat();
    ...
    private void setPermission() {
        ...
        logger().info("Successfully hooked with " + permission.getName() + " permissions");
    }
    ...
    private void setEconomy() {
        ...
        logger().info("Successfully hooked with " + economy.getName() + " economy");
    }
    ...
    private void setChat() {
        ...
        logger().info("Successfully hooked with " + chat.getName() + " chat");
    }
